...
export class AppComponent {
  ...
  public buttonClick1 = (): void => {
    this.rteObj.executeCommand('insertText', '#CUSROR#');
    console.log(this.rteObj.value);
    const test = this.rteObj.getContent();
    const value = test.innerHTML
      .toString()
      .replace(/#CUSROR#/, '<span>test3</span>');
    console.log(test);
  };
}
